...
from TdexFutureAPI import TdexFuture

#初始化apikey，secretkey,url
apikey = 'f1aac966-3add-4534-8cf6-c01b52341f67'
secretkey = 'CAD4C1F5D72C2686875C0397966CFEDE'
...
#期货API
okcoinFuture = TdexFuture(okcoinRESTURL, apikey, secretkey)
...
print (u'期货下单')
print (okcoinFuture.future_trade('ltc_usd','this_week','100000','1','1','1','10'))
