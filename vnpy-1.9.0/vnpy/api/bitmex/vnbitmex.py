...
class BitmexRestApi(object):
    ...
    #----------------------------------------------------------------------
    def generateSignature(self, path, expires, params=None, body=None):
        """生成签名"""
...
if __name__ == '__main__':
    API_KEY = "eAC1Psos5BKRMLeQ6HLwCW5Ffi5H3kr2xrTsuLzjPgx7rEMWG2bmJZ3ToN1K2TAd"
    API_SECRET = "eAC1PstJSk6kQHZSxYqbbezqbvEWdYCcWoU7q49Dhjac4z6YN3eAmrCgQZX2Cb9y"
